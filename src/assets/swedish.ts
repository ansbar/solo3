import { GeneralTexts } from "./textsInterfaces"
...
export const generalTexts: GeneralTexts = {
  general: {
    playerName: "Hämnaren",
    damage: "Skada",
    hp: "Kroppspoäng",
  ...
  items: {
    ...
    magicShuriken: 'Förtrollad shuriken'
  },
  defense: {
